      ...
      {items.map((item, idx) => {
        ...
        return (
          ...
          >
            ...
            <div className=" rounded-md w-full p-4 overflow-hidden bg-black group-hover:ring-2 ring-green-500 relative z-200 transition-all duration-500 cursor-pointer">
